...
hoistedDependencies:
  ...
  /@polka/url/1.0.0-next.21:
    '@polka/url': private
  /@rollup/plugin-commonjs/23.0.7_rollup@3.9.0:
    '@rollup/plugin-commonjs': private
  /@rollup/plugin-json/5.0.2_rollup@3.9.0:
    '@rollup/plugin-json': private
  /@rollup/plugin-node-resolve/15.0.1_rollup@3.9.0:
  ...
  /postcss-js/4.0.1_postcss@8.4.20:
    postcss-js: private
...
pendingBuilds: []
prunedAt: Wed, 19 Apr 2023 16:20:50 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@esbuild/win32-ia32/0.16.12
  - /@esbuild/win32-x64/0.16.12
storeDir: /Users/irene/Library/pnpm/store/v3
